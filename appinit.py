...
# Populate user table with one admin user and one testuser
...
admin_todo_list1 = ToDoList(title='Home-Improvements',description='All Home-improvements tasks', user=admin_user, date_created=datetime(2019,10,10))
admin_todo_list2 = ToDoList(title='Personal',description='All Personal tasks', user=admin_user, date_created=datetime(2019,10,11))

testuser_todo_list1 = ToDoList(title='Testing',description='All testing tasks', user=test_user, date_created=datetime(2019,10,10))
